/*
  Desafio HackerRank: Weather Observation Station 14  
  Link: https://www.hackerrank.com/challenges/weather-observation-station-14/problem?isFullScreen=true

  Enunciado:
  --------------------------------------------------
  Consulte o maior valor de Latitude do Norte (LAT_N) da tabela STATION 
  que seja menor que 137.2345. Trunque o resultado para 4 casas decimais.
